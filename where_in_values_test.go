...
func TestWhereInValues_Int(t *testing.T) {
	...
	assert.Equal(t, " IN($4,$5,$6,$7,$8)", sql)
	assert.Equal(t, []interface{}{0, 1, 2, 1, 5, 9, 6, 8}, args)
}
...
func TestWhereInValues_Int64(t *testing.T) {
	...
	sql, args := wv.Sql([]interface{}{0, 1, 2})
	assert.Equal(t, " IN($4,$5,$6,$7,$8)", sql)
	assert.Equal(t, []interface{}{0, 1, 2, int64(1), int64(5), int64(9), int64(6), int64(8)}, args)
}
